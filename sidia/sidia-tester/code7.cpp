...
// M�todo que conta as ocorrencias de digitos de X
...
// Fun��o que calcula o maior n�mero formados pelos digitos de X
int maior_numero_com_digitos_de(int X)
{
    ...
    for (int i = 9; i >= 0; i--)
    {
        ...
        // constru��o do novo n�mero multiplas vezes
        // X = 1555, o digito 5 deve ser usado 3 vezes na contru��o do novo n�mero
        while (digitos[i] != 0)
        {
            digitos[i]--;
            retorno += i * aux;
...
// Fun��o que calcula o menor n�mero formados pelos digitos de X
...
// Fun��o que enquantra quantas itera��es foram necess�rias para encontrar o numero de krapekar
int krapekar(int X)
{
    int cnt = 0;
...
int main()
{
    // T - N�mero de casos de teste
    // X - Inteiro de at� 4 digitos
    int T, X;
    cin >> T;
    for (int i = 0; i < T; i++)
    {
