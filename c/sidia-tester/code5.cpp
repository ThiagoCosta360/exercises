...
int main()
{
	// M � quantidade de linhas da imagem original
	// N � quantidade de colunas da imagem original
	// A � quantidade de linhas da imagem ampliada
	// B � quantidade de colunas da imagem ampliada
    int M, N, A, B;
